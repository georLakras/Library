				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><a href="index.php"><i class="icon-arrow-left52 position-left"></i></a> <span class="text-semibold">E-Books' Catalog. Here you can see a full list of all e-books in library.</h4>
						</div>
					</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="ebooks_catalog.php">E-Books' Catalog</a></li>
											...
											$output .= '<td class="text-center">
															<ul class="icons-list">
																<li class="dropdown">
																	...
																	<ul class="dropdown-menu dropdown-menu-right">
																		<li><a href="ebook.php?id='.$row['id'].'"><i class="icon-info3"></i> View details</a></li>
																		<li><a href="edit_ebook.php?id='.$row['id'].'"><i class="icon-pen6"></i> Edit e-book</a></li>
																		<li><a href="delete_ebook.php?id='.$row['id'].'"><i class="icon-cross2"></i> Delete e-book</a></li>
																	</ul>
																</li>
															</ul>
														</td>';
