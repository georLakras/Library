<?php 	include('config.php');
		...
		$query= 'SELECT writer.id AS writer_id, writer.first_name, writer.last_name, writer.country	 
				FROM writer 
				ORDER BY writer.id;';
				...
				<div class="page-header page-header-default">
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="writers_catalog.php">Writers' Catalog</a></li>
								...
								<?php 
									if ($result->num_rows>0){
										while($row=$result->fetch_assoc()){
											$output  = '<tr>';				
											$output .= '<th scope="row">'.$row['writer_id'].'</th>';
											...
											$output .= '<td class="text-center">
															<ul class="icons-list">
																<li class="dropdown">
																	...
																	<ul class="dropdown-menu dropdown-menu-right">
																		<li><a href="writer.php?id='.$row['writer_id'].'"><i class="icon-info3"></i> View details</a></li>
																		<li><a href="edit_writer.php?id='.$row['writer_id'].'"><i class="icon-pen6"></i> Edit writer</a></li>
																		<li><a href="delete_writer.php?id='.$row['writer_id'].'"><i class="icon-cross2"></i> Delete writer</a></li>
																	</ul>
																</li>
															</ul>
														</td>';
