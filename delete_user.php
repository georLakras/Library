<?php 	include('config.php');
		...
		$id = $_GET['id'];
		$query=	"SELECT user.first_name, user.last_name, user.username, user.email, user.create_time, user.avatar,
				 user.phone_number, admins.username AS admin, addresses.street, addresses.number, addresses.city, addresses.zip_code
				 FROM user
				...
				<div class="content">
								...
								<div class="content-group">
									<div class="thumbnail">
										<div class="thumb thumb-slide">
											<?php echo'<img src="data:image/jpeg;base64,'.base64_encode($avatar).'" alt="">'; ?>
											<div class="caption">
												<span>
													<?php echo'<a href="data:image/jpeg;base64,'.base64_encode($avatar).'" class="btn bg-success-400 btn-icon btn-xs" data-popup="lightbox"><i class="icon-plus2"></i></a>'; ?>
										...
										<div class="caption text-center">
											<h6 class="text-semibold no-margin"><?php echo $first_name," ", $last_name; ?><small class="display-block">UX/UI designer</small></h6>
					...
					<div class="container-detached">
						<div class="content-detached">
							...
							<div class="alert alert-danger alert-bordered" style="height: 100px">
								<button type="button" class="close" data-dismiss="alert"><span>×</span><span class="sr-only">Close</span></button>
								<span class="text-semibold">Warning!</span> This user will be deleted. Are you sure ?</a>
								</br>
								</br>
								<div class="col-xs-2">
									<?php echo '<form action="delete_u.php?id="'.$id.'">'; ?>
										<button type="submit" class="btn btn-danger btn-labeled"><b><i class="icon-x"></i></b> Delete </button>
									</form>
								</div>
								<div class="col-xs-2">
									<form action="users_catalog.php">
										<button type="submit" class="btn btn btn-labeled btn-labeled-right"><b><i class="icon-menu7"></i></b> Cancel</button>
									</form>
								</div>
							</div>
										...
										<div class="panel-body">
											<div class="tabbable">
												<ul class="nav nav-tabs bg-teal-400 nav-justified">
													<li class="active"><a href="#colored-justified-tab1" data-toggle="tab">Personal Info</a></li>
													<li><a href="#colored-justified-tab2" data-toggle="tab">Account Info</a></li>
																...
																<div class="row">
																	<div class="col-md-4">
																		...
																		<div class="input-group">
																			...
																			<input class="form-control bg-slate" value="<?php echo $first_name; ?>" type="text">																
																		</div>
																	</div>
																	<div class="col-md-4">
																		...
																		<div class="input-group">
																			...
																			<input class="form-control bg-slate" value="<?php echo $last_name; ?>" type="text">																
																		</div>
																	</div>
																</div>
															</div>
																...
																<div class="row">
																	<div class="col-md-4">
																		...
																		<div class="input-group">
																			...
																			<input class="form-control bg-slate" value="<?php echo $street,", ",$number; ?>" type="text">																
																		</div>
																	</div>
																	<div class="col-md-4">
																		...
																		<div class="input-group">
																			<span class="input-group-addon bg-slate-700"><i class="icon-address-book2"></i></span>
																			<input class="form-control bg-slate" value="<?php echo $city; ?>" type="text">																
																		</div>
																	</div>
																</div>
															</div>
																...
																<div class="row">
																	<div class="col-md-4">
																		...
																		<div class="input-group">
																			...
																			<input class="form-control bg-slate" value="<?php echo $phone_number; ?>" type="text">																
																		</div>
																		<span class="help-block">+30-99-9999-9999</span>
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																<div class="row">
																	<div class="col-md-4">
																		...
																		<div class="input-group">
																			...
																			<input class="form-control bg-slate" value="<?php echo $email; ?>" type="email">																
																		</div>
																	</div>
																	<div class="col-md-4">
																		<label>Created DateTime:</label>
																		<div class="input-group">
																			<span class="input-group-addon bg-slate-700"><i class="icon-plus2"></i></span>
																			<input class="form-control bg-slate" value="<?php echo $create_time; ?>" type="email">																
																		</div>
																	</div>
																</div>
																</br>
																<div class="row">
																	<div class="col-md-4">
																		...
																		<div class="input-group">
																			<span class="input-group-addon bg-slate-700"><i class=" icon-vcard"></i></span>
																			<input class="form-control bg-slate" value="<?php echo $username; ?>" type="text">																
																		</div>
																	</div>
																	<div class="col-md-2">
																		<label>ID:</label>
																		<div class="input-group">
																			<span class="input-group-addon bg-slate-700"><i class="icon-info3"></i></span>
																			<input class="form-control bg-slate" value="<?php echo $id; ?>" type="text">																
																		</div>
																	</div>		
																</div>								
															</div>
