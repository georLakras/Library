<?php 
	...
	if($_POST){
		...
		$address_query="INSERT INTO addresses (street, number, city, zip_code) 
						VALUES ('$address','$number','$city','$zip_code')";
		$result = mysqli_query($connect,$address_query);
		...
		$admin = $_SESSION['id'];
		$user_query="INSERT INTO user (first_name, last_name, email, phone_number, username, password, address, admins_id)
						VALUES ('$first_name','$last_name','$email','$phone','$username','$password','$address_id', '$admin');";
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Add a new user to your library.</h4>
						</div>
					</div>
									...
									<div class="panel-body">
										<fieldset>
											...
											<div class="form-group">
												...
												<div class="col-lg-6">
													<input type="text" name="phone" placeholder="+99-99-9999-9999" class="form-control" required="required">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-9">
													<div class="row">
														<div class="col-md-6">
								                            <input type="text" name="address" placeholder="Street" class="form-control" required="required">														
														</div>

														<div class="col-md-2">
															<input type="text" name="number" placeholder="Number" class="form-control mb-15" required="required">
														</div>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-lg-9">
													<div class="row">
														<div class="col-md-6">
								                            <input type="text" name="zip_code" placeholder="ZIP code" class="form-control" required="required">														
														</div>

														<div class="col-md-6">
															<input type="text" name="city" placeholder="City" class="form-control mb-15" required="required">
														</div>
													</div>
												</div>
											</div>
