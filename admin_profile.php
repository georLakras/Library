<?php 	include('config.php');
		...
		$query = "SELECT * FROM admins WHERE admins.id='$id';";
				...
				<div class="sidebar-content">
					...
					<div class="sidebar-user">
						<div class="category-content">
							<div class="media">
								<?php echo '<a href="#" class="media-left"><img src="'.$avatar.'" class="img-circle img-sm" alt=""></a>'; ?>
								<div class="media-body">
									<span class="media-heading text-semibold"><?php echo $first_name," ",$_SESSION['first_name']; ?></span>
									<div class="text-size-mini text-muted">
										<i class="icon-pin text-size-small"></i> &nbsp; <?php echo $username;?>
									</div>
								</div>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Αdmin Profile</span> - Tabbed</h4>
						</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<?php echo '<li class="active"><a href="admin_profile.php?id='.$_SESSION['id'].'">Admin Profile</a></li>'; ?>
						</ul>
								...
								<div class="content-group">
									<div class="thumbnail">
										<div class="thumb thumb-slide">
											...
											<div class="caption">
												<span>
													<?php echo'<a href="data:image/jpeg;base64,'.base64_encode($_SESSION['avatar']).'" class="btn bg-success-400 btn-icon btn-xs" data-popup="lightbox"><i class="icon-plus2"></i></a>'; ?>
																...
																<div class="row">
																	<div class="col-md-4">
																		...
																		<div class="input-group">
																			...
																			<input class="form-control bg-slate" value="Μακεδονίας, 4" type="text">																
																		</div>
																	</div>
																	<div class="col-md-4">
																		...
																		<div class="input-group">
																			<span class="input-group-addon bg-slate-700"><i class="icon-address-book2"></i></span>
																			<input class="form-control bg-slate" value="Ελευθέριο - Κορδελιό" type="text">																
																		</div>
																	</div>
																</div>
															</div>
																...
																<div class="row">
																	<div class="col-md-4">
																		...
																		<div class="input-group">
																			...
																			<input class="form-control bg-slate" value="+30 69 8600 9958" type="text">																
																		</div>
