<?php 	include('config.php');
		...
		$query ='SELECT publisher.id AS publisher_id, publisher.title, publisher.foundation_year	 
				 FROM publisher 
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><a href="index.php"><i class="icon-arrow-left52 position-left"></i></a> <span class="text-semibold">Publishers' Catalog. Here you can see a full list of publishers included in your library.</h4>
						</div>
					</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="publishers_catalog.php">Publishers' Catalog</a></li>
								...
								<?php 
									if ($result->num_rows>0){
										while($row=$result->fetch_assoc()){
											$output  = '<tr>';				
											$output .= '<th scope="row">'.$row['publisher_id'].'</th>';
											$output .= '<td>'.$row['title'].'</td>';
											$output .= '<td>'.$row['foundation_year'].'</td>';
											$output .= '<td class="text-center">
															<ul class="icons-list">
																<li class="dropdown">
																	...
																	<ul class="dropdown-menu dropdown-menu-right">
																		<li><a href="user_profile.php?id='.$row['publisher_id'].'"><i class="icon-info3"></i> View details</a></li>
																		<li><a href="edit_user.php?id='.$row['publisher_id'].'"><i class="icon-pen6"></i> Edit user</a></li>
																		<li><a href="delete_user.php?id='.$row['publisher_id'].'"><i class="icon-cross2"></i> Delete user</a></li>
																	</ul>
																</li>
															</ul>
														</td>';
