			...
			<div class="content-wrapper">
				...
				<div class="content">
		            ...
		            <div class="panel panel-white">
	                	...
	                	<form class="stepy-validation" action="add_book_action.php" method="post" enctype="multipart/form-data">
							<fieldset title="1">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="book_title" class="form-control required" placeholder="Enter here book's title.">
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="isbn" class="form-control required" placeholder="Enter here book's ISBN.">
										</div>
									</div>
										...
										<div class="row">		
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="first_name" class="form-control required" placeholder="Enter writer's first name here.">
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="last_name" class="form-control required" placeholder="Enter writer's first name here.">
												</div>
											</div>	
										</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<select class="select select-search" name="publishers" onchange="showPublisher(this.value)">
												<optgroup label="Mountain Time Zone">
													<option value="0" selected>Add new Publisher</option>
												</optiongroup>
							...
							<fieldset title="4">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											<label>Copies: <span class="text-danger">*</span></label>
											<input type="text" name="copies" placeholder="Company name" class="form-control">
										</div>
									</div>
