<?php 	include('config.php');
		...
		$query= 'SELECT user.id AS user_id, user.username, user.create_time, user.first_name, user.last_name, admins.username AS admin_name
				 FROM user 
				 INNER JOIN admins 
				 ON user.admins_id = admins.id 
				 ORDER BY user.id;';
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><a href="index.php"><i class="icon-arrow-left52 position-left"></i></a> <span class="text-semibold">Users' Catalog. Here you can see a full list of registered users of your library.</h4>
						</div>
					</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="users_catalog.php">Users' Catalog</a></li>
								...
								<?php 
									if ($result->num_rows>0){
										while($row=$result->fetch_assoc()){
											...
											$output .= '<td>'.$row['admin_name'].'</td>';
											$output .= '<td><span class="label label-success">Active</span></td>';
											$output .= '<td class="text-center">
															<ul class="icons-list">
																<li class="dropdown">
																	...
																	<ul class="dropdown-menu dropdown-menu-right">
																		<li><a href="user_profile.php?id='.$row['user_id'].'"><i class="icon-info3"></i> View details</a></li>
																		<li><a href="edit_user.php?id='.$row['user_id'].'"><i class="icon-pen6"></i> Edit user</a></li>
																		<li><a href="delete_user.php?id='.$row['user_id'].'"><i class="icon-cross2"></i> Delete user</a></li>
																	</ul>
																</li>
															</ul>
														</td>';
