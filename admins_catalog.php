<?php 	include('config.php');
		...
		$query= 'SELECT admins.id, admins.username, admins.create_time, admins.first_name, admins.last_name
				 FROM admins 
				 ORDER BY admins.id;';
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><a href="index.php"><i class="icon-arrow-left52 position-left"></i></a> <span class="text-semibold">Admins' Catalog. Here you can see a full list of your library's administrators.</h4>
						</div>
					</div>
					...
					<div class="breadcrumb-line">
						<ul class="breadcrumb">
							...
							<li class="active"><a href="admins_catalog.php">Admins' Catalog</a></li>
											...
											$output .= '<td class="text-center">
															<ul class="icons-list">
																<li class="dropdown">
																	...
																	<ul class="dropdown-menu dropdown-menu-right">
																		<li><a href="admin_profile.php?id='.$row['id'].'"><i class="icon-info3"></i> View details</a></li>
																	</ul>
																</li>
															</ul>
														</td>';
